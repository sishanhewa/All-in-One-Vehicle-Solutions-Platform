  ...
  try {
    ...
    for (const company of companies) {
      ...
      if (existing) {
        ...
        results.push({ company: company.companyProfile.companyName, email: company.email, password: company.password, status: 'ALREADY EXISTS' });
        continue;
      }
    ...
    console.log('\n' + '='.repeat(80));
    console.log('📋 INSPECTION COMPANY CREDENTIALS');
